...
sofabtn1 = Button(root, text="沙發", font=("Inter", 12), fg="#1E1E1E", bg="#ECE8E7", width=5, pady=2)
sofabtn1.grid(row=0, column=1, sticky=E+W)
bedding= Button(root, text="寢具", font=("Inter", 12), fg="#1E1E1E", bg="#ECE8E7", width=5, pady=2)
bedding.grid(row=0, column=2, sticky=E+W)
kitchen = Button(root, text="廚具", font=("Inter", 12), fg="#1E1E1E", bg="#ECE8E7", width=5, pady=2)
kitchen.grid(row=0, column=3, sticky=E+W)
loginbutton = Button(root, text="會員登入/註冊", font=("Inter", 12), fg="#1E1E1E", bg="#ECE8E7", width=12, pady=2)
...
# row=4
productprice1 = Label(root, text="NT.28,900", font=("Inter", 10), fg="#000000")
productprice2 = Label(root, text="NT.28,900", font=("Inter", 10), fg="#000000")
productprice3 = Label(root, text="NT.28,900", font=("Inter", 10), fg="#000000")
productprice4 = Label(root, text="NT.28,900", font=("Inter", 10), fg="#000000")
...
addbutton1 = Button(root, text="+", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
addbutton1.grid(row=4, column=1, sticky=E)
productnumber1 = Label(root, text="0", font=("Inter", 12, "bold"), fg="#000000")
productnumber1.grid(row=4, column=1, sticky=E+W)
minusbutton1 = Button(root, text="-", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
minusbutton1.grid(row=4, column=1, sticky=W)

addbutton2 = Button(root, text="+", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
addbutton2.grid(row=4, column=3, sticky=E)
productnumber2 = Label(root, text="0", font=("Inter", 12, "bold"), fg="#000000")
productnumber2.grid(row=4, column=3, sticky=E+W)
minusbutton2 = Button(root, text="-", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
minusbutton2.grid(row=4, column=3, sticky=W)

addbutton3 = Button(root, text="+", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
addbutton3.grid(row=4, column=5, sticky=E)
productnumber3 = Label(root, text="0", font=("Inter", 12, "bold"), fg="#000000")
productnumber3.grid(row=4, column=5, sticky=E+W)
minusbutton3 = Button(root, text="-", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
minusbutton3.grid(row=4, column=5, sticky=W)

addbutton4 = Button(root, text="+", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
addbutton4.grid(row=4, column=7, sticky=E)
productnumber4 = Label(root, text="0", font=("Inter", 12, "bold"), fg="#000000")
productnumber4.grid(row=4, column=7, sticky=E+W)
minusbutton4 = Button(root, text="-", font=("Inter", 10), fg="#1E1E1E", bg="#E7E2E2")
